...
const PHILOSOPHERS = {
  "ソクラテス・プラトン": {
    ...
    quote: "（ここに名言を挿入）",
    image: "（ここに画像URLを挿入）",
    description: "（ここに人物説明を挿入）",
    typeTitle: "（ここにタイプ見出しを挿入）",
    typeText: "（ここにタイプ説明を挿入）",
    books: [
      { title: "（ここにおすすめの本1を挿入）" },
      { title: "（ここにおすすめの本2を挿入）" }
    ]
  ...
  "カント": {
    ...
    quote: "我が天上の星空と、内なる道徳法則。",
    image: "https://i.imgur.com/lzDUtu5.png",
    description: `
      イマヌエル・カントは、18世紀ドイツの哲学者であり、近代哲学を完成させたとも評される思想家です。<br>
      彼は「理性の限界」と「自由な意志」を重視し、人間がどのように世界を認識し、どのように正しく行動すべきかを体系的に探求しました。<br><br>
      代表作『純粋理性批判』では、私たちの経験そのものを成り立たせている、人間の認識の根本にある仕組みを探求し明らかにすることで、<br>
      宇宙に果ては存在するのか、この世界には始まりと終わりがあるのかといった、哲学的難問を解き明かしました。<br><br>
      また倫理学では、「自らの行為が普遍的な法則となるように行為せよ」という道徳を掲げ、<br>
      理性による自律的な生き方の中に、真に自由な存在としての尊厳に満ちた人間のあり方を見出しました。<br><br>
      理性と道徳を軸に、確かな人間の理解に基づく地に足のついた世界の理解と、<br>
      人間のあるべき姿の理想を両立させる思想家です。
    `,
    typeTitle: "決して諦めず理想を追求し続けるファイター",
    typeText: `
      あなたは、理性的で誠実、そして道徳心の強いタイプです。<br>
      感情や状況に流されず、「正しいこととは何か」を自分の内なる理性によって判断しようとします。<br>
      社会や他者との関係においても、損得や感情よりも「筋が通っているか」「全員がこうしたらどうなるか」を基準に、<br>
      普遍的な基準を重んじて行動する傾向があります。<br><br>
      そのため、公平さや誠実さを重視し、責任感が強く、信頼される存在です。<br><br>
      このタイプの人は、興味の範囲が広く様々な問題について考え続けていますが、<br>
      思考の深さと慎重さを持ち、安易な結論を避けます。<br>
      物事の複雑さと現実的な制約の理解が、思考の前提にあります。<br><br>
      現実の割り切れなさにしばしば打ちのめされますが、<br>
      それでも決して諦めることなく、何度も立ち上がって理想を追求し続けられる強さを持っています。<br>
      この理想を決して諦めない態度こそが、カントタイプを最も特徴づけている性格です。<br><br>
      また、このタイプは自らの良心を信じて行動する独立した精神の持ち主でもあります。<br>
      外からの評価や感情的な衝動に支配されず、道徳的な一貫性を大切にします。<br><br>
      あなたは、理性の力と意志の力をもって、世界をより正しく認識し、<br>
      またより正しいものにしようと戦い続ける、「理想の探求者」です。
    `,
    books: [
      { title: "『プロレゴメナ』" },
      {
        title: "『道徳形而上学の基礎づけ』",
        note: "※倫理学・哲学の専門用語が多く難解です。入門書や解説書の併読がおすすめです。"
      }
    ]
  },

  "ヘーゲル": {
    displayName: "ゲオルク・ヘーゲル",
    quote: "（ここに名言を挿入）",
    image: "（ここに画像URLを挿入）",
    description: "（ここに人物説明を挿入）",
    typeTitle: "（ここにタイプ見出しを挿入）",
